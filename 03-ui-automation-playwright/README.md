...
UI waits are based on real visual signals (loaders, masks, spinners), not only network idle states.

**Precise element selection**  
Prevents wrong element interactions (e.g. `S` vs `XS`) using strict selectors.

**Reliable interactions**  
Handles overlays, blocked elements, and layout conflicts for stable clicking and typing.
